...
if age >= 18:
    print("You are eligible to vote.") #output: You are eligible to vote.
    print("You can also run for office.") #output: You can also run for office.
    print("You can also serve on a jury.") #output: You can also serve on a jury.

#using variables in if statements-

is_logged_in=True
if is_logged_in:    
    print("Welcome back!") #output: Welcome back! (Python can evaluate many types of values as true or false, such as non-empty strings, non-zero numbers, and non-empty lists)
