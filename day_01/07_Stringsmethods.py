...
#upper()- the upper method converts all characters in a string to uppercase. Here is an example:
a="Surendra"
...
#lower()- the lower method converts all characters in a string to lowercase. Here is an example:  
a="Surendra"
...
#strip()- the strip method removes any leading and trailing whitespace from a string. Here is an example:
a="  surendra  "
...
#lstrip()- the lstrip method removes any leading whitespace from a string. Here is an example:  
a="  surendra  "
...
#rstrip()- the rstrip method removes any trailing whitespace from a string. Here is an example:  
a="  surendra  "
...
#replace()- the replace method replaces all occurrences of a specified substring with another substring. Here is an example:
a="The ai is the future"
print(a.replace("ai","artificial intelligence")) # Output: The artificial intelligence is the future        

#split()- the split method splits a string into a list of substrings based on a specified delimiter. Here is an example:
a="The ai is the future"
...
#capitalize()- the capitalize method capitalizes the first character of a string and converts the rest of the characters to lowercase. Here is an example:
a="the ai is the future"
...
#casefold()- the casefold method is similar to the lower method, but it is more aggressive in converting characters to lowercase. It is used for caseless matching of strings. Here is an example:
a="The ai is the future"
...
#center: returns a centered string here is the example:
a="Surendra"
print(a.center("=")) # Output: ===Surendra=== - The center() method centers the string a within a field of a specified width (in this case, the width is determined by the length of the string plus the number of padding characters). The padding character used is "=". The resulting string is "===Surendra===", which is centered with "=" characters on both sides.

#count - returns the number of occurrences of a substring in a string. Here is an example:
...
#encode- returns an encoded version of the string. Here is an example:
a="The ai is the future"
...
#endswith- returns True if the string ends with a specified suffix, otherwise returns False. Here is an example:
a="The ai is the future"
...
#expandtabs- returns a copy of the string where all tab characters are replaced with spaces. Here is an example:
a="The\tai\tis\tthe\tfuture"
...
#find,Index- returns the lowest index of the substring if it is found in the string, otherwise returns -1. Here is an example:
a="The ai is the future"
...
#format- formats specified values in a string. Here is an example:
name="Surendra"
...
#isalnum- returns True if all characters in the string are alphanumeric (letters and numbers), otherwise returns False. Here is an example:
a="Surendra123"
...
#isalpha- returns True if all characters in the string are alphabetic (letters only), otherwise returns False. Here is an example:
a="Surendra"
...
#title- returns a title-cased version of the string, where the first character of each word is capitalized and the rest are lowercase. Here is an example:
a="the ai is the future"
...
#startswith() and endswith() methods are used to check if a string starts or ends with a specified substring, respectively. Here is an example:
a="The ai is the future"
...
#join()-used to join a list of strings into a single string with a specified separator. Here is an example:
...
#isupper-check wheather each character in the string is uppercase or not. Here is an example:
a="SURNDRA" 
...
#islower-check whether each character in the string is lowercase or not. Here is an example:    
a="surendra"
...
#extend()-the extend() method is not a string method, it is a list method. It is used to extend a list by appending all the items from another iterable (such as another list). Here is an example:
my_list=["The","ai","is","the","future"]
